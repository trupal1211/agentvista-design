...
const NotFound = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden hero-gradient pt-16">
      {/* Background blobs */}
      ...
      <div className="container relative z-10 mx-auto px-4 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center justify-items-center max-w-7xl mx-auto">
          ...
          >
            <h1 className="text-5xl md:text-6xl lg:text-6xl font-extrabold mb-6 text-gradient leading-tight">
              404
              <br />
              Page Not Found
            </h1>
